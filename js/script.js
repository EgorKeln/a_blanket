function fitElementToParent(el, padding) {
  ...
  var advancedStaggeringAnimation = (function() {
    ...
    var staggerVisualizerEl = document.querySelector('.new-visualizer');
    var shapesWrapperEl = staggerVisualizerEl.querySelector('.shapes-wrapper');
    var shapesFragment = document.createDocumentFragment();
    var grid = [20, 10];
    var cell = 55;
    ...
    for (var i = 0; i < numberOfElements; i++) {
      ...
      shapesFragment.appendChild(shapeEl);
    }
  
    shapesWrapperEl.appendChild(shapesFragment);
  
    var index = anime.random(0, numberOfElements-1);
    var nextIndex = 0;
  
    anime.set('.new-visualizer .cursor', {
